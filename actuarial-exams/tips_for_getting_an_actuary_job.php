...
<div class = "row">
       ...
       <?php include "includes/left_nav.php"; ?>
        ...
        <!--Main Content-->
            <div class="borderbox">
           <h2 class = "custom_more_margin" id = "tip_for_getting_actuary_job" >Tips for getting an Actuary Job?</h2>
           </div>
           ...
           <h4>1. Network</h4>
            ...
            <div class="whitebox"> 
                ...
                <h4>4. Never stop programming</h4>
                <p>
