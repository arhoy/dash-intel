          ...
          <div class="col-md-6">
           <div class="card  mb-15">
              <div class="card-block mb-15">
                ...
                <a href="powerbi/index.php" class="btn btn-primary mt-15 mb-15">Learn More</a>
                <ul class="list-group list-group-flush">
             <li class="list-group-item">Easy to setup and learn</li>
             <li class="list-group-item">Aggresively being improved by Microsoft </li>
             <li class="list-group-item">Free or very low cost options</li>
            </ul>
              </div>
            </div>
          </div>
           ...
           <div class="card mb-15">
              <div class="card-block mb-15">
                ...
                <h2 class="card-text">The Current Leader in Dashboard Visualizations</h2>
                <a href="tableau/index.php" class="btn btn-success mt-15 mb-15">Learn More</a>
                <ul class="list-group list-group-flush">
                <li class="list-group-item">Connections with all data sources</li>
                <li class="list-group-item">Best visualizations and most intuitive</li>
                <li class="list-group-item">Expensive but still #1 for a reason</li>
            </ul>
              </div>
            </div>
          </div>
           ...
           <div class="card mb-15">
              ...
              <h1 class="card-title">Javascript</h1>
                <h2 class="card-text">Learn the basics of javascript and start programming the web!</h2>
                <a href="js/index.php" class="btn btn-info mt-15 mb-15">Learn more</a>
                <ul class="list-group list-group-flush">
                <li class="list-group-item">Beginner tutorials on getting started with vanilla javascript!</li>
                <li class="list-group-item">Learn about javascript objects, functions and inheritance</li>
                <li class="list-group-item">Learn about ES2015 and ES6+ javascript</li>
            </ul>
              </div>
            </div>
          </div>
