      ...
      <li class="nav-item dropdown active"><!--Start of Drop Down List-->
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink"> <!-- dropdown menu start-->
          <div class = "col-sm-12"> 
              <h4 class = "dropdown_header"></h4>
              <div>
                <a class= "dropdown-item" href="./#tb_intro">Tableau Overview</a>
                <a class= "dropdown-item" href="date_calculations_tableau.php">Date Calculations</a>
                <a class= "dropdown-item" href="stats_calculations_tableau.php">Stats Calculations</a>
                <a class= "dropdown-item" href="lod_expressions_menu_tableau.php">LOD Expressions</a>
                <a class= "dropdown-item" href="creating_set_tableau.php">Tableau Sets</a>
